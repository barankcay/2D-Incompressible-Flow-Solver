step01 ---> FDM, staggered, contains only uniform grid solver code, lid driven cavity, channel flow
...
step05 ---> FVM, staggered, contains nonuniform grid solver code, lid driven cavity, channel flow